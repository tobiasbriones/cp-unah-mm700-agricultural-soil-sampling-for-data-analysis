...
\title{Anteproyecto de Investigación: Muestro de suelo agrícola para análisis de datos mediante investigación con encuestas y modelado de diseños de muestreo eficientes}
...
La población que se tomará, en términos generales, será el conjunto de todos los lotes del terreno.

\subsection{Muestra}

Como muestra se deberá seleccionar la configuración adecuada de acuerdo a lo que dicte la metodología realizada en este trabajo.
